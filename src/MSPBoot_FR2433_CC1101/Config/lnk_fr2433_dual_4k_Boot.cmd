...
_Appl_End = 0xd9ff;                 /* End of Application area */
_Flex_Start = 0xda00;             /* Start of flex space (app or download, project-dependent) */
_Flex_End = 0xefff;                 /* End of flex space (app or download, project-dependent) */
_Down_Start = 0xda00;			/* Download Area */
_Down_End = 0xefff;        /*End of Download Area */
