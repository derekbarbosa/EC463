...
const chrono::nanoseconds fractionalNS = chrono::nanoseconds(250);
const chrono::nanoseconds smallNS = chrono::nanoseconds(1000);
const chrono::nanoseconds varNS = chrono::nanoseconds(2000);
